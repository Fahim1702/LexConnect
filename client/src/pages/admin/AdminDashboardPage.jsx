...
export default function AdminDashboardPage() {
  ...
  const cards = [['Users', data.stats.users, Users], ['Lawyers', data.stats.lawyers, Briefcase], ['Services', data.stats.services, Scale], ['Pending requests', data.stats.pending, MessageSquare], ['Testimonials to review', data.stats.pendingTestimonials, Star]];
